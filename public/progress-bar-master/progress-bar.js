...
(function (window) {
  function initProgressBar() {
    ...
    var createElement = function (type, className, style, text,idName) {
    ...
    var createStatusBar = function(stages, stageWidth, currentStageIndex) {
      ...
      var currentStatus = createElement('div', 'current-status', {}, '','current-status');
    ...
    var createCheckPoints = function(stages, stageWidth, currentStageIndex) {
      ...
      for (var index = 0; index < stages.length; index++) {
        var li = createElement('li', 'section', {width: stageWidth + '%'}, stages[index],stages[index]);
    ...
    ProgressBar.tahid= function(indexChange){
      for (var index = 0; index < Tstages.length; index++) {
        var mystage = Tstages[index];
        console.log(mystage)
      }
    }
